...
const displayController = () => { 
    ...
    const initSubmitNoteButton = () => {
        ...
        submitButton.addEventListener('click', () => {
            let formInfo = _utils_js__WEBPACK_IMPORTED_MODULE_0__.processForm();
...
let date = new Date();
let dateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'MM/dd/yyyy');
