...
const displayController = () => {
    const initButtons = () => {
        ...
        submitButton.addEventListener('click', () => {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.processForm(form);
