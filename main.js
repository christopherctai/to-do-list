...
const displayController = () => {
    const initButtons = () => {
        ...
        addNoteButton.addEventListener('click', () => {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.openForm();
        })
        closeNoteButton.addEventListener('click', () => {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.closeForm();
        })
        submitButton.addEventListener('click', () => {
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.processForm();
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.clearForm();
            _utils_js__WEBPACK_IMPORTED_MODULE_0__.closeForm();
        })
    }
